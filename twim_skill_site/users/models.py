...
class OperationsGame(models.Model):
    """Модель операций связанных с матчем"""
    operation = models.ForeignKey(Operations, on_delete=models.CASCADE, related_name="d", verbose_name="Операция")
    match = models.ForeignKey(Match, on_delete=models.CASCADE, related_name="d", verbose_name="Матч")
