...
class Lobby(models.Model):
    ...
    game_type = models.ForeignKey(GameType, on_delete=models.CASCADE, related_name='+', verbose_name='Тип игры')
    game_mode = models.ForeignKey(GameMode, on_delete=models.CASCADE, related_name='+', verbose_name='Режим игры')
    veto = models.ForeignKey(Veto, on_delete=models.CASCADE, related_name='+', verbose_name='Вето')
